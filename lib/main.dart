...
import 'package:wallet_crytocurrency/ui/component.dart';
import 'package:wallet_crytocurrency/ui/screen/home.dart';
...
class _MainAppState extends State<MainApp> {
  ...
  Widget _buildScreen() {
    switch (_currentItem) {
      ...
      case TabItem.setting:
        return Container(child: const Center(child: Text('Setting'),));
